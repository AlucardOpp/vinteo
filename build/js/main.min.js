...
/* harmony import */ var _modules_init_scroll_to__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-scroll-to */ "./js/modules/init-scroll-to.js");
/* harmony import */ var _modules_form_not_empty_inputs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/form/not-empty-inputs */ "./js/modules/form/not-empty-inputs.js");
/* harmony import */ var _modules_sliders_init_projects_slider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/sliders/init-projects-slider */ "./js/modules/sliders/init-projects-slider.js");
/* harmony import */ var _modules_sliders_init_clients_slider__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/sliders/init-clients-slider */ "./js/modules/sliders/init-clients-slider.js");
/* harmony import */ var _modules_init_accordion__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/init-accordion */ "./js/modules/init-accordion.js");
/* harmony import */ var _modules_modals_init_consent_modal_btns__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/modals/init-consent-modal-btns */ "./js/modules/modals/init-consent-modal-btns.js");
/* harmony import */ var _modules_init_recaptcha__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/init-recaptcha */ "./js/modules/init-recaptcha.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_form_not_empty_inputs__WEBPACK_IMPORTED_MODULE_5__["initNotEmptyInputs"])();
    Object(_modules_init_scroll_to__WEBPACK_IMPORTED_MODULE_4__["initScrollTo"])();
    Object(_modules_sliders_init_projects_slider__WEBPACK_IMPORTED_MODULE_6__["initProjectsSlider"])();
    Object(_modules_sliders_init_clients_slider__WEBPACK_IMPORTED_MODULE_7__["initClientsSlider"])();
    Object(_modules_init_accordion__WEBPACK_IMPORTED_MODULE_8__["initAccordions"])();
    Object(_modules_modals_init_consent_modal_btns__WEBPACK_IMPORTED_MODULE_9__["initConsentModalBtns"])();
    Object(_modules_init_recaptcha__WEBPACK_IMPORTED_MODULE_10__["initRecaptcha"])();
  });
}); // ---------------------------------
...
/* harmony import */ var _form_validate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./form-validate */ "./js/modules/form/form-validate.js");
...
var baseValidationSuccessCallback = function baseValidationSuccessCallback(e) {
  ...
  postAjax('mail.php', new URLSearchParams(formData).toString() + '&parent-class=' + e.target.parentElement.className, function (data) {
    if (JSON.parse(data).form === 'form--consulting') {
      _modals_init_modals__WEBPACK_IMPORTED_MODULE_0__["modals"].open('success-consulting');
    } else if (JSON.parse(data).form === 'form--faq') {
      _modals_init_modals__WEBPACK_IMPORTED_MODULE_0__["modals"].open('success-faq');
    } else {
      _modals_init_modals__WEBPACK_IMPORTED_MODULE_0__["modals"].open('success');
    }
...
var initFormValidate = function initFormValidate() {
  if (formWrappers.length) {
    ...
    formWrappers.forEach(function (wrapper) {
      ...
      var formValidate = new _form_validate__WEBPACK_IMPORTED_MODULE_1__["default"](wrapper, callbacks[callback]);
...
/***/ "./js/modules/form/not-empty-inputs.js":
/*!*********************************************!*\
  !*** ./js/modules/form/not-empty-inputs.js ***!
  \*********************************************/
/*! exports provided: initNotEmptyInputs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initNotEmptyInputs", function() { return initNotEmptyInputs; });
var initNotEmptyInputs = function initNotEmptyInputs() {
  ...
  forms.forEach(function (it) {
    it.addEventListener('change', function (evt) {
      var inputWrap = evt.target.closest('.custom-input') || false;
      var textareaWrap = evt.target.closest('.custom-textarea') || false;
...
/*!**************************************!*\
  !*** ./js/modules/init-recaptcha.js ***!
  \**************************************/
/*! exports provided: initRecaptcha */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initRecaptcha", function() { return initRecaptcha; });
var API_KEY = '6LeJfsseAAAAAKSHgjmEWggX6ZtzPRDsa9OUw1wx';
...
var createCaptcha = function createCaptcha(id) {
...
var initRecaptcha = function initRecaptcha() {
  var myCaptchaEls = document.querySelectorAll('.my-captcha');

  if (!myCaptchaEls.length) {
    return;
  }

  myCaptchaEls.forEach(function (element) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initScrollTo", function() { return initScrollTo; });
...
var scrollTo = function scrollTo(target) {
  ...
  var distance = Math.abs(targetTopPosition - window.scrollY);
...
/***/ "./js/modules/modals/init-consent-modal-btns.js":
/*!******************************************************!*\
  !*** ./js/modules/modals/init-consent-modal-btns.js ***!
  \******************************************************/
/*! exports provided: initConsentModalBtns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initConsentModalBtns", function() { return initConsentModalBtns; });
var initConsentModalBtns = function initConsentModalBtns() {
  var consentCheckboxes = document.querySelectorAll('[data-consent="checkbox"]');

  if (!consentCheckboxes.length) {
    return;
  }

  var acceptBtn = document.querySelector('[data-consent="yes"]');
  var declineBtn = document.querySelector('[data-consent="no"]');
  acceptBtn.addEventListener('click', function () {
    consentCheckboxes.forEach(function (it) {
...
var openTrialModal = function openTrialModal() {
  if (window.location.search.indexOf('?trial') !== -1) {
    modals.open('trial');
  }
};

var personalDataClose = function personalDataClose() {
  document.addEventListener('click', function (evt) {
    var btn = evt.target.closest('[data-close-callback]');

    if (btn) {
      setTimeout(function () {
        modals._closeCallback = function () {
...
var initModals = function initModals() {
  ...
  openTrialModal(); // Используйте в разработке экспортируемую переменную modals, window сделан для бэкэнда
...
/***/ "./js/modules/sliders/init-clients-slider.js":
/*!***************************************************!*\
  !*** ./js/modules/sliders/init-clients-slider.js ***!
  \***************************************************/
/*! exports provided: initClientsSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var initClientsSlider = function initClientsSlider() {
  var clientsNode = document.querySelector('.clients .swiper');
  ...
  var swiper = new Swiper(clientsNode, {
    slidesPerView: 2.5,
    spaceBetween: 20,
    loop: true,
    slidesPerGroup: 1,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initProjectsSlider", function() { return initProjectsSlider; });
var projects = document.querySelector('.projects');

var initProjectsSlider = function initProjectsSlider() {
  if (!projects) {
    return;
  }

  var swiper = projects.querySelector('.swiper');
